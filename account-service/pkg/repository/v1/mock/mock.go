...
import (
	...
	db "optisam-backend/account-service/pkg/repository/v1/postgres/db"
	reflect "reflect"
)
...
func (m *MockAccount) CreateScope(arg0 context.Context, arg1, arg2, arg3 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateScope", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateScope indicates an expected call of CreateScope
func (mr *MockAccountMockRecorder) CreateScope(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateScope", reflect.TypeOf((*MockAccount)(nil).CreateScope), arg0, arg1, arg2, arg3)
}
