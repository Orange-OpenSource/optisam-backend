...
type MetricServiceClient interface {
	...
	CreateMetricWindowServerStandard(ctx context.Context, in *MetricWSS, opts ...grpc.CallOption) (*MetricWSS, error)
...
func (c *metricServiceClient) CreateMetricWindowServerStandard(ctx context.Context, in *MetricWSS, opts ...grpc.CallOption) (*MetricWSS, error) {
	out := new(MetricWSS)
	err := c.cc.Invoke(ctx, "/optisam.metric.v1.MetricService/CreateMetricWindowServerStandard", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetricServiceServer interface {
	...
	CreateMetricWindowServerStandard(context.Context, *MetricWSS) (*MetricWSS, error)
...
func (UnimplementedMetricServiceServer) CreateMetricWindowServerStandard(context.Context, *MetricWSS) (*MetricWSS, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMetricWindowServerStandard not implemented")
}
...
func _MetricService_CreateMetricWindowServerStandard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MetricWSS)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetricServiceServer).CreateMetricWindowServerStandard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/optisam.metric.v1.MetricService/CreateMetricWindowServerStandard",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricServiceServer).CreateMetricWindowServerStandard(ctx, req.(*MetricWSS))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _MetricService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateMetricWindowServerStandard",
			Handler:    _MetricService_CreateMetricWindowServerStandard_Handler,
		},
		{
