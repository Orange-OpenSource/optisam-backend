...
import (
	...
	v1 "gitlab.tech.orange/optisam/optisam-it/optisam-services/account-service/thirdparty/metric-service/pkg/api/v1"
...
func (m *MockMetricServiceClient) CreateMetricWindowServerStandard(ctx context.Context, in *v1.MetricWSS, opts ...grpc.CallOption) (*v1.MetricWSS, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CreateMetricWindowServerStandard", varargs...)
...
func (mr *MockMetricServiceClientMockRecorder) CreateMetricWindowServerStandard(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMetricWindowServerStandard", reflect.TypeOf((*MockMetricServiceClient)(nil).CreateMetricWindowServerStandard), varargs...)
}
...
// CreateMetricWindowServerStandard mocks base method
func (m *MockMetricServiceServer) CreateMetricWindowServerStandard(arg0 context.Context, arg1 *v1.MetricWSS) (*v1.MetricWSS, error) {
	m.ctrl.T.Helper()
...
// CreateMetricWindowServerStandard indicates an expected call of CreateMetricWindowServerStandard
func (mr *MockMetricServiceServerMockRecorder) CreateMetricWindowServerStandard(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMetricWindowServerStandard", reflect.TypeOf((*MockMetricServiceServer)(nil).CreateMetricWindowServerStandard), arg0, arg1)
}
