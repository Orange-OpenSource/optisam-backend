...
type AccountServiceClient interface {
	...
	ResendAccountActivationToken(ctx context.Context, in *ResendAccountActivationRequest, opts ...grpc.CallOption) (*ResendAccountActivationResponse, error)
	...
	//GetAdminUserScope returns admin details for a particular scope
	GetAdminUserScope(ctx context.Context, in *GetAdminUserScopeRequest, opts ...grpc.CallOption) (*GetAdminUserScopeResponse, error)
}
...
func (c *accountServiceClient) ResendAccountActivationToken(ctx context.Context, in *ResendAccountActivationRequest, opts ...grpc.CallOption) (*ResendAccountActivationResponse, error) {
	out := new(ResendAccountActivationResponse)
	err := c.cc.Invoke(ctx, "/optisam.account.v1.AccountService/ResendAccountActivationToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountServiceClient) GetAdminUserScope(ctx context.Context, in *GetAdminUserScopeRequest, opts ...grpc.CallOption) (*GetAdminUserScopeResponse, error) {
	out := new(GetAdminUserScopeResponse)
	err := c.cc.Invoke(ctx, "/optisam.account.v1.AccountService/GetAdminUserScope", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	ResendAccountActivationToken(context.Context, *ResendAccountActivationRequest) (*ResendAccountActivationResponse, error)
	...
	//GetAdminUserScope returns admin details for a particular scope
	GetAdminUserScope(context.Context, *GetAdminUserScopeRequest) (*GetAdminUserScopeResponse, error)
}
...
func (UnimplementedAccountServiceServer) ResendAccountActivationToken(context.Context, *ResendAccountActivationRequest) (*ResendAccountActivationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResendAccountActivationToken not implemented")
}
...
func (UnimplementedAccountServiceServer) GetAdminUserScope(context.Context, *GetAdminUserScopeRequest) (*GetAdminUserScopeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAdminUserScope not implemented")
}
...
func _AccountService_ResendAccountActivationToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResendAccountActivationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).ResendAccountActivationToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/optisam.account.v1.AccountService/ResendAccountActivationToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).ResendAccountActivationToken(ctx, req.(*ResendAccountActivationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AccountService_GetAdminUserScope_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAdminUserScopeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).GetAdminUserScope(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/optisam.account.v1.AccountService/GetAdminUserScope",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).GetAdminUserScope(ctx, req.(*GetAdminUserScopeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AccountService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ResendAccountActivationToken",
			Handler:    _AccountService_ResendAccountActivationToken_Handler,
		},
		{
		...
		{
			MethodName: "GetAdminUserScope",
			Handler:    _AccountService_GetAdminUserScope_Handler,
		},
	},
