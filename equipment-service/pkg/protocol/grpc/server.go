...
func RunServer(ctx context.Context, v1API v1.EquipmentServiceServer, port string, verifyKey *rsa.PublicKey, p *rego.PreparedEvalQuery, apiKey string) error {
	...
	v1.RegisterEquipmentServiceServer(server, v1API)
