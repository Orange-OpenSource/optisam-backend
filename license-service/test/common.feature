...
Feature: Common utilities and authentication
  ...
  @ignore
  Scenario: Verify license service is up and running
    * def licenseServiceInstUrl = replace(karate.get('licenseServiceUrl'),'license','license-inst')
    * url licenseServiceInstUrl
    Given path 'healthz'
