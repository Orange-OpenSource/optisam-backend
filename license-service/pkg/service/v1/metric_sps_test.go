...
func Test_licenseServiceServer_CreateMetricSAGProcessorStandard(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("licenseServiceServer.CreateMetricSAGProcessorStandard() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("licenseServiceServer.CreateMetricSAGProcessorStandard() = %v, want %v", got, tt.want)
			}
		})
	}
}
