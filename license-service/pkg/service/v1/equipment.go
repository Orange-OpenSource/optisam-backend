...
func (s *licenseServiceServer) ListEquipmentsMetadata(ctx context.Context, req *v1.ListEquipmentMetadataRequest) (*v1.ListEquipmentMetadataResponse, error) {
	...
	res, err := s.licenseRepo.MetadataAllWithType(ctx, repo.MetadataTypeEquipment, userClaims.Socpes)
	if err != nil {
		switch err {
		case repo.ErrNoData:
...
func (s *licenseServiceServer) EquipmentsTypes(ctx context.Context, req *v1.EquipmentTypesRequest) (*v1.EquipmentTypesResponse, error) {
	userClaims, ok := ctxmanage.RetrieveClaims(ctx)
	if !ok {
		return nil, status.Error(codes.Internal, "cannot find claims in context")
	}
	res, err := s.licenseRepo.EquipmentTypes(ctx, userClaims.Socpes)
	if err != nil {
...
func (s *licenseServiceServer) CreateEquipmentType(ctx context.Context, req *v1.EquipmentType) (*v1.EquipmentType, error) {
	userClaims, ok := ctxmanage.RetrieveClaims(ctx)
	if !ok {
		return nil, status.Error(codes.Internal, "cannot find claims in context")
	}
	...
	metadata, err := s.licenseRepo.MetadataWithID(ctx, req.MetadataId, userClaims.Socpes)
	if err != nil {
		switch err {
		case repo.ErrNoData:
			return nil, status.Error(codes.NotFound, "cannot fetch equipment metadata")
	...
	resp, err := s.licenseRepo.CreateEquipmentType(ctx, servEquipTypeToRepoType(req), userClaims.Socpes)
	if err != nil {
...
func (s *licenseServiceServer) UpdateEquipmentType(ctx context.Context, req *v1.UpdateEquipmentTypeRequest) (*v1.EquipmentType, error) {
	userClaims, ok := ctxmanage.RetrieveClaims(ctx)
	if !ok {
		return nil, status.Error(codes.Internal, "cannot find claims in context")
	}
	...
	metadata, err := s.licenseRepo.MetadataWithID(ctx, equip.SourceID, userClaims.Socpes)
	if err != nil {
		switch err {
		case repo.ErrNoData:
			return nil, status.Error(codes.NotFound, "cannot fetch equipment metadata")
	...
	resp, err := s.licenseRepo.UpdateEquipmentType(ctx, equip.ID, equip.Type, repoUpdateRequest, userClaims.Socpes)
	if err != nil {
...
func (s *licenseServiceServer) GetEquipmentMetadata(ctx context.Context, req *v1.EquipmentMetadataRequest) (*v1.EquipmentMetadata, error) {
	userClaims, ok := ctxmanage.RetrieveClaims(ctx)
	if !ok {
		return nil, status.Error(codes.Internal, "cannot find claims in context")
	}
	metadata, err := s.licenseRepo.MetadataWithID(ctx, req.ID, userClaims.Socpes)
	if err != nil {
		switch err {
		case repo.ErrNoData:
			return nil, status.Error(codes.NotFound, "cannot fetch equipment metadata")
...
func equipmentTypeExistsByID(ID string, eqTypes []*repo.EquipmentType) (*repo.EquipmentType, error) {
	...
	return nil, status.Errorf(codes.Unknown, "equipment not exists")
}
...
func repoEquipProductToServiceEquipProductAll(products []*repo.EquipmentProduct) []*v1.EquipmentProduct {
	servProduct := make([]*v1.EquipmentProduct, len(products))
	for i := range products {
		servProduct[i] = repoEquipProductToServiceEquipProduct(products[i])
	}
	return servProduct
}

func repoEquipProductToServiceEquipProduct(prod *repo.EquipmentProduct) *v1.EquipmentProduct {
	return &v1.EquipmentProduct{
