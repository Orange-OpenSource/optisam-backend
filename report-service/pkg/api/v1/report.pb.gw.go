...
var (
	pattern_ReportService_ListReportType_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "reports", "types"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReportService_SubmitReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "reports"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReportService_ListReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "reports"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReportService_DownloadReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "reports", "reportID"}, "", runtime.AssumeColonVerbOpt(true)))
)
