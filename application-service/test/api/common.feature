...
Feature: Common utilities and authentication
  ...
  @ignore
  Scenario: Verify Application service is up and running
    * def applicationServiceInstUrl = replace(karate.get('applicationServiceUrl'),'application','application-inst')
    * url applicationServiceInstUrl
    Given path 'healthz'
