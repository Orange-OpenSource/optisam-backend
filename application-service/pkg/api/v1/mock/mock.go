...
func (m *MockApplicationServiceClient) UpsertApplicationEquip(arg0 context.Context, arg1 *v1.UpsertApplicationEquipRequest, arg2 ...grpc.CallOption) (*v1.UpsertApplicationEquipResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockApplicationServiceClientMockRecorder) UpsertApplicationEquip(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
